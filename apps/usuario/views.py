...
def signup(request):
    ...
    return render(request, 'usuario/welcome.html', {"e": email})
...
def plantilla2(request):
    return render(request, 'usuario/plantilla2.html')
...
def premios2(request):
    return render(request, 'usuario/premios2.html')
